...
import { Home, KeyRound, BarChart3, CreditCard, LifeBuoy, User, Menu } from "lucide-react"
    ...
    <Sheet>
      <SheetTrigger asChild>
        <button
          ...
          className="md:hidden inline-flex items-center justify-center rounded-md border px-2.5 py-2 text-sm hover:bg-accent"
        >
